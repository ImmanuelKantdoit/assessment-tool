...
class PrivateQuestionAPIAPITests(TestCase):
    ...
    def test_create_exam_question(self):
        ...
        exam = Question.objects.get(id=res.data['id'])

        self.assertEqual(payload['question'], exam.question)
    ...
    #     print("Updated question:", exam_question.question)
...
#     def test_create_question_with_new_choices(self):
...
#         question = create_question()
#         old_choice = Choice.objects.create(
#             question=question,
#             choice="Choice 1",
#         )
#         question.choices.add(old_choice)
